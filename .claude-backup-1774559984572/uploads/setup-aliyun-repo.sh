...
echo ""
echo "请输入 deployment-server 项目的本地绝对路径"
...
if git remote | grep -q "origin"; then
    ...
    git remote set-url origin git@codeup.aliyun.com:6808da56fb3da14b899afd54/deployment-server.git
else
    echo "→ 添加远程仓库..."
    git remote add origin git@codeup.aliyun.com:6808da56fb3da14b899afd54/deployment-server.git
fi
...
echo "远程仓库: git@codeup.aliyun.com:6808da56fb3da14b899afd54/deployment-server.git"
echo ""
