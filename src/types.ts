...
export type OutboundPayload =
  ...
  | { kind: 'status.completed'; metadata?: { durationMs?: number; ttftMs?: number; numTurns?: number; tokenUsage?: { input_tokens?: number; output_tokens?: number; cache_read_input_tokens?: number; cache_creation_input_tokens?: number }; contextUsage?: { totalTokens: number; maxTokens: number; percentage: number; autoCompactTokens?: number; model: string; effort?: string }; lastModelCall?: { messageId?: string; requestId?: string; model?: string; tokenUsage: { input_tokens?: number; output_tokens?: number; cache_read_input_tokens?: number | null; cache_creation_input_tokens?: number | null; [key: string]: unknown }; contextUsage?: { totalTokens: number; maxTokens: number; percentage: number; autoCompactTokens?: number; model: string; effort?: string } } } }
