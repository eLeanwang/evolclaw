...
// 支持的命令列表
const commands = ['/new', '/pwd', '/plist', '/project', '/bind', '/help', '/evolhelp', '/status', '/restart', '/model', '/setmodel', '/effort', '/agent', '/slist', '/session', '/rename', '/stop', '/clear', '/compact', '/repair', '/safe', '/fork', '/del', '/perm', '/file', '/check', '/rewind', '/activity', '/chatmode', '/ask', '/resume', '/aid', '/rpc', '/storage', '/trigger'];
...
const quickCommandPrefixes = ['/new', '/pwd', '/plist', '/project', '/bind', '/help', '/evolhelp', '/status', '/restart', '/model', '/setmodel', '/effort', '/agent', '/slist', '/session', '/rename', '/repair', '/fork', '/stop', '/clear', '/compact', '/safe', '/del', '/perm', '/file', '/check', '/p ', '/s ', '/name', '/rewind', '/rw', '/rw ', '/activity', '/chatmode', '/ask', '/resume', '/aid', '/rpc', '/storage', '/trigger'];
...
3. /session <名称> - 切换到已有会话`;
    ...
    if (normalizedContent === '/trigger' || normalizedContent.startsWith('/trigger ')) {
      return this.handleTrigger(normalizedContent, channel, channelId, userId ?? '', isAdmin);
    }
