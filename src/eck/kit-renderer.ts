...
const PARAM_DESCRIPTIONS: Record<string, string> = {
  ...
  venueDir: '当前群环境本地目录',
  groupRulesPath: '群规则本地缓存文件',
  groupRulesRemotePath: '群规则在群资源空间中的路径',
  groupRulesUpdatedAt: '群规则最近同步时间',
  groupRulesSyncStatus: '群规则同步状态（synced/cached/stale/missing/error/disabled）',
  groupRulesSyncError: '群规则同步错误',
  groupResourceIndexPath: '群资源索引本地缓存文件',
  groupResourceIndexUpdatedAt: '群资源索引最近同步时间',
  groupResourceIndexCount: '群资源索引条目数',
